                ...
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                    ...
                    <form onSubmit={(e) => onSubmit(e)}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type={"email"} className="form-control" placeholder="Enter your email address" name="email" value={email} onChange={(e) => onInputChange(e)}></input>
                        </div>
                        <button type="submit" className="btn btn-outline-primary">Submit</button>
                        <Link to="/"><button type="submit" className="btn btn-outline-danger mx-2">Back</button></Link>
                    </form>
                </div>
            </div>
        </div>
